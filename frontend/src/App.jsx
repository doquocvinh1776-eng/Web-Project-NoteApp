    ...
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div className="note-actions">
        <button 
          ...
          style={{ padding: '10px 20px', color: 'var(--primary-color)', border: '1px solid var(--primary-color)', cursor: 'pointer', fontWeight: '600', display: editingNote && !editingNote.is_shared ? 'block' : 'none' }}
        >
           👥 Chia sẻ
        </button>
        <button 
          ...
          style={{ padding: '10px 20px', color: '#f59e0b', border: '1px solid #f59e0b', cursor: 'pointer', fontWeight: '600', display: editingNote && !editingNote.is_shared ? 'block' : 'none' }}
        >
        ...
        <button 
          ...
          style={{ padding: '10px 20px', color: '#ef4444', border: '1px solid #ef4444', cursor: 'pointer', fontWeight: '600', display: editingNote?.id && !editingNote.is_shared ? 'block' : 'none' }}
        >
           🗑 Xóa ghi chú
        </button>
      </div>
